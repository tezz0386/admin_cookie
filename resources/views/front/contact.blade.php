...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-100 mb-3">
        ...
        <input type="email" id="lname" class="form-mail" name="email" placeholder="Your email..">
      </div>
    </div>
      ...
      <button type="button" class="btn btn-danger" value="submit">Submit</button>
          ...
          <div class="contact-loacation clearfix">  
              <article class="float-left article">
                  ...
                  <p>Madhyapur Thimi-9,Bhaktapur</p>
                  <p>9801192470</p>
                  <p>imperialbaking@gmail.com</p>
              </article>

                  <ul class="float-right social-links">
                  <li><a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i>Facebook/Dawncookies</a></li>
              <li><a href="https://www.instagram.com/"><i class="fab fa-instagram"></i>Instagram/Dawncookies</a></li>
              <li><a href="https://twitter.com/?lang=en"><i class="fab fa-twitter"></i>Twiter/Dawncookies</a></li>
                </ul>
              </div>
        </div> <!-- .container -->
