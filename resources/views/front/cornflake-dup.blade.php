      ...
      <div class="wrapper">
        <div class="container">
          <div class="row about-wrapper">
            <div class="col-md-12">
              <h1 class="c-title"><span>Dawn</span>  Cornflakes</h1>
...
Here, we'll explore some of the most creative company profile examples, to ensure you're able to create a company profile that will attract and engage the right audience. Once you're done perusing these impressive examples, take a look at our template to get started designing your own.</p>
          ...
          <div class="about-content row">
            ...
            <div class="col-md-6">
              <h1>Dawn Cornflakes</h1>
              <p>Dawn Cornflakes are actually the most popular breakfast cereal, which are made up of toasting flakes of corn. They are packaged cereal product prepared from small toasted flakes of corn, and are generally served either with cold or hot milk and sugar. It is a breakfast cereals made by combining milled corn with sugar Milled corn products are believed to enable easier utilization of vitamins and nutrients as compared to their non-milled counterparts.</p>
              <!-- <a href="#" class="btn order-now">order now</a> -->
            </div>
            <div class="col-md-6">
            <img src="assets/images/product-01.png" class="img-fluid">
            </div>


            <div class="col-md-6">
            <img src="assets/images/product-09.png" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Dawn Cornflakes(low sugar)</h1>
              <p>Dawn Cornflakes(low sugar) are actually the most popular breakfast cereal, which are made up of toasting flakes of corn. They are packaged cereal product prepared from small toasted flakes of corn, and are generally served either with cold or hot milk and sugar. It is a breakfast cereals made by combining milled corn with sugar Milled corn products are believed to enable easier utilization of vitamins and nutrients as compared to their non-milled counterparts.</p>
              <!-- <a href="#" class="btn order-now">order now</a> -->
            </div>
            ...
            <div class="col-md-6">
              <h1>Dawn Instant Oats</h1>
              <p>Dawn Instant Oats are actually the most popular breakfast cereal, which are made up of toasting flakes of corn. They are packaged cereal product prepared from small toasted flakes of corn, and are generally served either with cold or hot milk and sugar. It is a breakfast cereals made by combining milled corn with sugar Milled corn products are believed to enable easier utilization of vitamins and nutrients as compared to their non-milled counterparts.</p>
            </div>
            <div class="col-md-6">
            <img src="assets/images/product-08.png" class="img-fluid">
            </div>

            
            <div class="col-md-6">
            <img src="assets/images/product-07.png" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Dawn Cornflakes(25% extra)</h1>
              <p>Dawn Cornflakes(25% extra) are actually the most popular breakfast cereal, which are made up of toasting flakes of corn. They are packaged cereal product prepared from small toasted flakes of corn, and are generally served either with cold or hot milk and sugar. It is a breakfast cereals made by combining milled corn with sugar Milled corn products are believed to enable easier utilization of vitamins and nutrients as compared to their non-milled counterparts.</p>
            </div>

            <div class="col-md-6">
              <h1>Cornflakes Rolled</h1>
              <p>Cornflakes Rolled are actually the most popular breakfast cereal, which are made up of toasting flakes of corn. They are packaged cereal product prepared from small toasted flakes of corn, and are generally served either with cold or hot milk and sugar. It is a breakfast cereals made by combining milled corn with sugar Milled corn products are believed to enable easier utilization of vitamins and nutrients as compared to their non-milled counterparts.</p>
            </div>
            <div class="col-md-6">
            <img src="assets/images/rolled.png" class="img-fluid">
            </div>

            <div class="col-md-6">
            <img src="assets/images/jar.png" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Cornflakes Jar</h1>
              <p>Cornflakes Jar are actually the most popular breakfast cereal, which are made up of toasting flakes of corn. They are packaged cereal product prepared from small toasted flakes of corn, and are generally served either with cold or hot milk and sugar. It is a breakfast cereals made by combining milled corn with sugar Milled corn products are believed to enable easier utilization of vitamins and nutrients as compared to their non-milled counterparts.</p>
            </div>
          </div> 
        </div> <!-- .container -->
      </div><!--- .wrapper -->
