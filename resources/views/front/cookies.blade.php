                 ...
                 <li class="nav-item dropdown drop-nav">
                      ...
                      <ul class="dropdown-product">
                        ...
                        <ul class="dropdown-more">
                          ...
                          <li><a href="crookies.html">Ribbon Cookies</a></li>
                        </ul>
                      </li>
...
Here, we'll explore some of the most creative company profile examples, to ensure you're able to create a company profile that will attract and engage the right audience. Once you're done perusing these impressive examples, take a look at our template to get started designing your own.</p>
          ...
          <div class="about-content row">
            ...
            <div class="col-md-6">
              <h1>Digestive Biscuits</h1>
              <p>Digestive biscuits which are coated on the bottom with milk, dark or white chocolate are also available.A digestive biscuit, sometimes described as a sweet-meal biscuit, is a semi-sweet biscuit that originated in Scotland. The digestive was first developed in 1839 by two Scottish doctors to aid digestion. ... First manufactured in 1892, McVitie's digestive is the best-selling biscuit in the UK.</p>
              <!-- <a href="#" class="btn order-now">order now</a> -->
            </div>
            <div class="col-md-6">
            <img src="assets/images/product-04.jpg" class="img-fluid">
            </div>


            <div class="col-md-6">
            <img src="assets/images/product-05.jpg" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Tiger Biscuits</h1>
              <p>Tiger biscuits which are coated on the bottom with milk, dark or white chocolate are also available.A digestive biscuit, sometimes described as a sweet-meal biscuit, is a semi-sweet biscuit that originated in Scotland. The digestive was first developed in 1839 by two Scottish doctors to aid digestion. ... First manufactured in 1892, McVitie's digestive is the best-selling biscuit in the UK.</p>
            </div>
            ...
            <div class="col-md-6">
              <h1>Ribbon Salt & Sweet</h1>
              <p>Ribbon Salt & Sweet which are coated on the bottom with milk, dark or white chocolate are also available.A digestive biscuit, sometimes described as a sweet-meal biscuit, is a semi-sweet biscuit that originated in Scotland. The digestive was first developed in 1839 by two Scottish doctors to aid digestion. ... First manufactured in 1892, McVitie's digestive is the best-selling biscuit in the UK.</p>
            </div>
            <div class="col-md-6">
            <img src="assets/images/product-33.jpg" class="img-fluid">
            </div>

            
            <div class="col-md-6">
            <img src="assets/images/product-22.jpg" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Sugar Free Digestive Cookies</h1>
              <p>Sugar Free Digestive Cookies which are coated on the bottom with milk, dark or white chocolate are also available.A digestive biscuit, sometimes described as a sweet-meal biscuit, is a semi-sweet biscuit that originated in Scotland. The digestive was first developed in 1839 by two Scottish doctors to aid digestion. ... First manufactured in 1892, McVitie's digestive is the best-selling biscuit in the UK.</p>
            </div>

            <div class="col-md-6">
              <h1>Breaktime Cookies</h1>
              <p>Breaktime Cookies which are coated on the bottom with milk, dark or white chocolate are also available.A digestive biscuit, sometimes described as a sweet-meal biscuit, is a semi-sweet biscuit that originated in Scotland. The digestive was first developed in 1839 by two Scottish doctors to aid digestion. ... First manufactured in 1892, McVitie's digestive is the best-selling biscuit in the UK.</p>
            </div>
            <div class="col-md-6">
            <img src="assets/images/bt.jpg" class="img-fluid">
            </div>

            <div class="col-md-6">
            <img src="assets/images/product-11.jpg" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Millinium Cookies</h1>
              <p>Millinium Cookies which are coated on the bottom with milk, dark or white chocolate are also available.A digestive biscuit, sometimes described as a sweet-meal biscuit, is a semi-sweet biscuit that originated in Scotland. The digestive was first developed in 1839 by two Scottish doctors to aid digestion. ... First manufactured in 1892, McVitie's digestive is the best-selling biscuit in the UK.</p>
            </div>
          </div> 
        </div> <!-- .container -->
      </div><!--- .wrapper -->
