      ...
      <div class="wrapper">
        <div class="container">
          <div class="row about-wrapper">
            <div class="col-md-12">
              <h1 class="c-title"><span>About</span>  Dawn Cookies</h1>
...
Here, we'll explore some of the most creative company profile examples, to ensure you're able to create a company profile that will attract and engage the right audience. Once you're done perusing these impressive examples, take a look at our template to get started designing your own.</p> <br>
...
Here, we'll explore some of the most creative company profile examples, to ensure you're able to create a company profile that will attract and engage the right audience. Once you're done perusing these impressive examples, take a look at our template to get started designing your own.</p>
          ...
          <div class="about-content row">
            ...
            <div class="col-md-6">
              <img src="assets/images/approach.jpg" class="img-fluid">
            </div>
            <div class="col-md-6">
              <h1>Our Approach</h1>
              <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur</p>
            ...
            <div class="col-md-6">
              <img src="assets/images/process.jpg" class="img-fluid">
            </div>
