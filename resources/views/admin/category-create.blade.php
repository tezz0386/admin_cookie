				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" placeholder="Title" aria-label="title" aria-describedby="basic-addon1" name="title" required="required" value="{{old('title')}}">
						</div>
				...
				<div class="card">
					...
					<div class="card card-body">
						<div class="form-group">
							...
							<input type="text" name="title_tag" class="form-control" id="meta_title_tag" value="{{old('title_tag')}}">
						</div>
						<div class="form-group">
							<label for="meta_keywords">Meta Keywords</label>
							<textarea class="form-control" name="meta_keywords" id="meta_keywords" style="height: 150px;">{{old('meta_keywords')}}</textarea>
						</div>
						<div class="form-group">
							<label for="meta_description">Meta Description</label>
							<textarea class="form-control" name="meta_description" id="meta_description" style="height: 200px;">{{old('meta_description')}}</textarea>
						</div>
					</div>
