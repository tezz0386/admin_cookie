			...
			<div class="card card-body">
				<div class="row">
					<div class="col-md-6 col-lg-6">
						...
						<div class="form-group">
							<label>
								<img src="{{asset('thumbnail.png')}}" id="imgthumbnail" class="img-fluid" alt="Image not found" height="640" width="444">
					...
					<div class="col-md-6 col-lg-6">
						...
						<textarea name="description" class="form-control" style="height: 100%" required="required">{{old('description')}}</textarea>
					</div>
				</div>
			</div>
