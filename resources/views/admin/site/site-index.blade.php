		...
		<div class="card">
			...
			<div class="card card-body">
				<div class="form-group">
					...
					<input type="text" name="site_title" class="form-control" value="{{old('site_title', $site->site_title)}}">
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>
										...
										<input type="file" name="logo" id="thumbnail" hidden="hidden" value="{{old('logo')}}">
									</label>
								</div>
							</div>
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>
										...
										<input type="file" name="md_profile" id="md_profile" hidden="hidden" value="{{old('md_profile')}}">
									</label>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<textarea class="form-control" style="height: 250px;" name="description">{{old('description', $site->description)}}</textarea>
						</div>
						<div class="form-group">
							<label for="address">Address:</label>
							<input type="text" name="address" class="form-control"  placeholder="Your Company Full Address" value="{{old('address', $site->address)}}">
						</div>
						<div class="form-group">
			...
			<div class="card card-footer">
				<div>
					<button class="btn btn-primary float-right btn-lg bg-primary" style="color: white;" type="submit">Submit</button>
				</div>
			</div>
		</div>
	</form>
